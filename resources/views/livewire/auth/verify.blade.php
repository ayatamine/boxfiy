...
<div  class="mt-40">
    <div class="sm:mx-auto sm:w-full sm:max-w-3xl">
        ...
        <h2 class="mt-6 text-4xl font-extrabold text-center text-gray-900 leading-9 text-white">
            Verify your email address
        </h2>

        <p class="mt-2 text-2xl text-center leading-7 text-white">
            Or
    ...
    <div class="mt-8  mx-8 sm:mx-auto sm:w-full sm:max-w-3xl">
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            @if (session('resent'))
                <div class="flex items-center px-4 py-3 mb-6 text-2xl text-white bg-green-500 rounded shadow" role="alert">
