        ...
        <div class="row">
            <div class="signup-content">
                <div class="text">
                    ...
                    <form action="" method="" wire:submit.prevent="resetPassword">
                        ...
                        <div class="input">
                            <label><img src="{{asset('boxfiyV6/images/icons/18.png')}}"></label>
                            <input wire:model.lazy="passwordConfirmation" placeholder="passwordConfirmation" type="password" name="" class="">
                        </div>
