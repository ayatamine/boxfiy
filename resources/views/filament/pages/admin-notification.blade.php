    ...
    <div class="container mx-auto">
        <h1 class="text-2xl font-bold mb-4 flex justify-between items-center">
           <span> Notifications List</span>
            <a @click="markAllAsRead" class="flex gap-2 items-center text-sm bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 rounded">
            ...
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-gray-500">
                    ...
                    @if($notification->type =='App\Notifications\NewTicketReplyNotification')
                    <a class="text-blue-600 underline underline-offset-2" href="{{route('filament.resources.tickets.view',['record'=>$notification->data['ticket_id']])}}" class="mx-3">View Ticket</a>
                    @endif
                </p>
              </div>
            </div>
